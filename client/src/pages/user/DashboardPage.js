...
import { Package, Pill, Heart, Wallet } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {stats.map((stat, index) => (
              <div key={index} className="bg-card rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                ...
                <tbody>
                  {recentOrders.map((order, index) => (
                    <tr key={index} className="border-b border-border hover:bg-muted">
                      ...
                      <td className="py-4 px-4 text-muted-foreground">{order.items}</td>
                      ...
                      <td className="py-4 px-4 font-medium text-foreground">{order.amount}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
