      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {concerns.map((concern) => (
            <div
              key={concern.name}
              className="text-center p-6 bg-card rounded-lg shadow-md hover:shadow-xl hover:-translate-y-1 transition-transform duration-300 cursor-pointer"
            >
              <div className="text-primary mb-4">{concern.icon}</div>
