        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/prescriptions" className="text-gray-400 hover:text-white">
                  {t('prescriptions')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services/vaccinations" className="text-gray-400 hover:text-white">
                  {t('vaccinations')}
                </Link>
              </li>
              <li>
                <Link to="/services/health-checks" className="text-gray-400 hover:text-white">
                  {t('healthChecks')}
                </Link>
              </li>
              <li>
                <Link to="/services/consultations" className="text-gray-400 hover:text-white">
                  {t('consultations')}
                </Link>
              </li>
              <li>
                <Link to="/services/chronic-medication" className="text-gray-400 hover:text-white">
                  {t('chronicMedication')}
                </Link>
              </li>
            </ul>
