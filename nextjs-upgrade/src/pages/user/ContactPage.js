            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
              ...
              <form>
                ...
                <div className="mb-6">
                  ...
                  <textarea 
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 h-32"
            ...
            <div>
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 bg-teal-100 dark:bg-teal-900 rounded-full p-3 mr-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        123 Pharmacy Street, Riyadh, Saudi Arabia
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 dark:bg-gray-700 hover:bg-teal-100 dark:hover:bg-teal-900 text-gray-800 dark:text-gray-200 p-3 rounded-full transition-colors">
